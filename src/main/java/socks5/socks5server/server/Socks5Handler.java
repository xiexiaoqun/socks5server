...
import socks5.socks5server.client.SocksSocket;
...
import socks5.socks5server.server.io.PipeListener;
import socks5.socks5server.server.io.SocketPipe;
import socks5.socks5server.server.msg.*;
...
public class Socks5Handler implements SocksHandler {
    ...
    private Set<String> preProxyExclude = new HashSet<String>(){{
        add("127.0.0.1");
        add("192.168.3.1");
    }};
    ...
    public void doConnect(Session session, CommandMessage commandMessage) throws SocksException,
        ...
        try {
            ...
            if (proxy == null || hostName.startsWith("192.168") || hostName.startsWith("127.0.0.1") || hostName.startsWith("10.")) {
